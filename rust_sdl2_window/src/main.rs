...
static TETROMINO_SHAPES: LazyLock<Vec<Vec<Vec<(i32, i32)>>>> = LazyLock::new(|| {
    vec![
        // I
        vec![
            vec![(0, 0), (-1, 0), (1, 0), (2, 0)],
...
static JLSTZ_KICKS: LazyLock<Vec<Vec<Vec<(i32, i32)>>>> = LazyLock::new(|| {
    vec![
        // Clockwise
        vec![
...
static I_KICKS: LazyLock<Vec<Vec<Vec<(i32, i32)>>>> = LazyLock::new(|| {
    vec![
        // Clockwise
        vec![
